...
object Migration1 extends Migration {
  ...
  class Users(tag: Tag) extends Table[(Int, String, String, String, Boolean, Long)](tag, Some(InitDB.SCHEMA_NAME), "USER_ACCOUNTS") {
    ...
    def * = (id, username, email, hashedPassword, registered, createdMillis)
  }
