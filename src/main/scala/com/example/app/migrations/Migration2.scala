...
object Migration2 extends Migration {
  ...
  class Questions(tag: Tag) extends Table[(String, Int, String, String, Boolean, Long, Long)](tag, Some(InitDB.SCHEMA_NAME), "QUESTIONS") {
    ...
    def * = (id, creatorId, title, text, isActive, createdMillis, updatedMillis)

    def creator = foreignKey("QUESTION_TO_USERS_FK", creatorId, Tables.UserAccounts)(_.userAccountId)
  }

  class Answers(tag: Tag) extends Table[(String, String, Int, String, Boolean, Long, Long)](tag, Some(InitDB.SCHEMA_NAME), "ANSWERS") {
    ...
    def * = (id, questionId, creatorId, text, isActive, createdMillis, updatedMillis)
  ...
  class Comments(tag: Tag) extends Table[(String, Int, Option[String], Option[String], String, Boolean, Long, Long)](tag, Some(InitDB.SCHEMA_NAME), "COMMENTS") {
    ...
    def * = (id, creatorId, questionId, answerId, text, isActive, createdMillis, updatedMillis)
