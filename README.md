...
This is a simple question-answer forum built using scalatra with a connection to Postgres/H2 db with Slick and serving up a react/redux web front end.
...
2. If not, it will create the schema "CURBSIDE", and the basic migrations tables
...
```sh
$ cd curbside/src/main/webapp/front-end
